...
with open("./inputs/level4/level4-0.in", 'r') as file:
...
# path_start_indexes = []
# 
# for i, char in enumerate(path_data):
#     if not char.isalpha() and path_data[i+1].isalpha():
#         # The beginning of a new path
#         path_start_indexes.append(i)
#         
# for i, index in enumerate(path_start_indexes):
#     if i == len(path_start_indexes)-1:
#         end_index = len(path_start_indexes)-1
#     else:
#         end_index = path_start_indexes[i+1]
#     separated_path_data.append(path_data[path_start_indexes[i]:end_index])
# =============================================================================
...
for char in path_data:
    if hold != []:
        if hold[-1].isalpha() and not char.isalpha():
            split.append(''.join(hold))
            hold = []
    hold.append(char)
...
def plot_path(colour_pairs, path_data):
    # Parse path data
...
plot_path(colour_pairs, path_data)
